...
#line 1 "NONE"
	...
	goto st162;
tr12:
#line 65 "lexer_turtle.rl"
	{{p = (( shared_lexer->env.te))-1;}{
              lexer_emit_token(STRING_LITERAL, var(ts) + 1, (var(te) - 1) - (var(ts) + 1));
        }}
	goto st162;
tr20:
#line 71 "lexer_turtle.rl"
	{ shared_lexer->env.te = p+1;{
              lexer_emit_token(STRING_LITERAL, var(ts) + 3, (var(te) - 3) - (var(ts) + 3));
        }}
	goto st162;
tr37:
#line 106 "lexer_turtle.rl"
	{{p = (( shared_lexer->env.te))-1;}}
	goto st162;
tr39:
#line 103 "lexer_turtle.rl"
	{ shared_lexer->env.te = p+1;}
	goto st162;
tr51:
#line 68 "lexer_turtle.rl"
	{{p = (( shared_lexer->env.te))-1;}{
              lexer_emit_token(STRING_LITERAL,  var(ts) + 1, (var(te) - 1) - (var(ts) + 1));
        }}
	goto st162;
tr59:
#line 74 "lexer_turtle.rl"
	{ shared_lexer->env.te = p+1;{
              lexer_emit_token(STRING_LITERAL, var(ts) + 3, (var(te) - 3) - (var(ts) + 3));
        }}
	goto st162;
tr79:
#line 59 "lexer_turtle.rl"
	{{p = (( shared_lexer->env.te))-1;}{ lexer_emit_token(INTEGER_LITERAL, var(ts), var(te) - var(ts)); }}
	goto st162;
tr81:
#line 50 "lexer_turtle.rl"
	{{p = (( shared_lexer->env.te))-1;}{
              lexer_emit_token(QNAME_LITERAL, var(ts), var(te) - var(ts));
        }}
	goto st162;
tr113:
#line 54 "lexer_turtle.rl"
	{ shared_lexer->env.te = p+1;{
              // '<' URI_LITERAL '>'
...
#line 50 "lexer_turtle.rl"
	...
	goto st162;
tr239:
#line 81 "lexer_turtle.rl"
	{ shared_lexer->env.te = p;p--;{
              lexer_emit_token(LANGTAG,var(ts), var(te) - var(ts));
        }}
	goto st162;
tr250:
#line 78 "lexer_turtle.rl"
	{ shared_lexer->env.te = p+1;{
...
#line 1 "NONE"
	{ shared_lexer->env.te = p+1;}
#line 46 "lexer_turtle.rl"
	{ shared_lexer->env.act = 3;}
	goto st188;
tr247:
#line 1 "NONE"
	{ shared_lexer->env.te = p+1;}
#line 44 "lexer_turtle.rl"
...
#line 1 "NONE"
	{ shared_lexer->env.te = p+1;}
#line 47 "lexer_turtle.rl"
	{ shared_lexer->env.act = 4;}
	goto st198;
tr169:
#line 1 "NONE"
	{ shared_lexer->env.te = p+1;}
#line 45 "lexer_turtle.rl"
	{ shared_lexer->env.act = 2;}
	goto st198;
tr172:
#line 1 "NONE"
	{ shared_lexer->env.te = p+1;}
#line 62 "lexer_turtle.rl"
