...
/**
  ...
  */
int ardp_fprintf(FILE *fp, const char *color, const char *fmt, ...) __attribute__((__format__ (__printf__, 3,4 )));
int ardp_fprintf_ln(FILE *fp, const char *color, const char *fmt, ...) __attribute__((__format__ (__printf__, 3,4 )));
